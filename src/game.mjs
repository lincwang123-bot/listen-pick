...
import { availableTextbookLevels } from "./course/textbook-playable.generated.mjs?v=stage3-assets-v20";
import { textbookLevels } from "./course/textbook-levels-001-300.generated.mjs?v=stage3-assets-v20";
...
function createTextbookChoice(label, imagePath, theme) {
  return {
    label,
    image: toOptimizedImagePath(imagePath),
    alt: label,
